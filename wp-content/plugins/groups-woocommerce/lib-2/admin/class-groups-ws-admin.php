...
// 		add_action( 'admin_print_styles-' . $admin_page, array( __CLASS__, 'admin_print_styles' ) );
	...
	public static function groups_woocommerce() {
		...
		echo '<h1>' . __( 'Groups', GROUPS_WS_PLUGIN_DOMAIN ) . '</h1>';

		echo
			'<form action="" name="options" method="post">' .
			'<div>' .

			'<h2>' . __( 'Group membership', GROUPS_WS_PLUGIN_DOMAIN ) . '</h2>' .
			'<h3>' . __( 'Order Status', GROUPS_WS_PLUGIN_DOMAIN ) . '</h3>' .
			'<p>' .
			...
			'<h3>' . __( 'Subscription Status', GROUPS_WS_PLUGIN_DOMAIN ) . '</h3>' .
			'<p>' .
			'<label>' .
			...
			'<h2>' . __( 'Durations', GROUPS_WS_PLUGIN_DOMAIN ) . '</h2>' .
			'<p>' .
			'<label>' .
			...
			'<h2>' . __( 'Force registration', GROUPS_WS_PLUGIN_DOMAIN ) . '</h2>' .
			'<p>' .
			'<label>' .
			...
			'<h2>' . __( 'User profiles', GROUPS_WS_PLUGIN_DOMAIN ) . '</h2>' .
			'<p>' .
			'<label>' .
