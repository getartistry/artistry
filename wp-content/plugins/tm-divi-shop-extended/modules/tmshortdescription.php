<?php 
class ET_Builder_Module_SD extends ET_Builder_Module {
	function init() {
		$this->name       = esc_html__( 'Wc Short Description', 'et_builder' );
		$this->slug       = 'et_pb_wcshort_desc';
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$max_width_last_edited = $this->shortcode_atts['max_width_last_edited'];
		      ...
		      /////////////////////TEMPLATE WOOCOMERCE SHORT_DESCRIPTION////////////
