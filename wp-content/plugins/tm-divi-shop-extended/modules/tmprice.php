<?php 
class ET_Builder_Module_Price extends ET_Builder_Module {
	function init() {
		$this->name       = esc_html__( 'Wc Price', 'et_builder' );
		$this->slug       = 'et_pb_wcprice';
		...
		$this->advanced_options = array(
			'fonts' => array(
				'text'   => array(
					...
					'css'      => array(
						'main' => "{$this->main_css_element} p.price",
						'important' => 'all',
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$class = " et_pb_module et_pb_bg_layout_{$background_layout} et_pb_text_align_{$text_orientation}";
                                ...
                                ob_start();
                                if( !is_admin() ) woocommerce_template_single_price();
