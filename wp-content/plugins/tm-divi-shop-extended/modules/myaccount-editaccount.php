<?php 
class ET_Builder_Module_editaccount extends ET_Builder_Module {
	function init() {
		$this->name       = esc_html__( 'Wc EditAccount', 'et_builder' );
		$this->slug       = 'et_pb_editaccount';
...
new ET_Builder_Module_editaccount;
?>