<?php
class ET_Builder_Module_GalleryProduct extends ET_Builder_Module {
	function init() {
		$this->name       = esc_html__( 'Wc Gallery Product', 'et_builder' );
		$this->slug       = 'et_pb_gallery_product';
...
new ET_Builder_Module_GalleryProduct
?>