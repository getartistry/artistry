<?php
/*
Plugin name: Artistry Unfold
Plugin URI: https://artistry.ink
Description: Move or copy an Artistry site to another server or to another domain name, move to/from local server hosting, and backup sites.
Author: Artistry
Version: 10.0
Author URI: https://artistry.ink
*/
...
function wpclone_plugin_menu() {
    add_menu_page (
        'Artistry Unfold Plugin Options',
        'Artistry Unfold',
        'manage_options',
        'wp-clone',
...
function wpa_wpc_msnotice() {
    ...
    echo '<h4>Artistry Unflod Notice.</h4>';
    echo '<p>Artistry Unflod is not compatible with multisite installations.</p></div>';
}
...
function wpa_wpc_phpnotice() {
    echo '<div class="error">';
    echo '<h4>Artistry Unflod Notice.</h4>';
    printf( '<p>Artistry Unflod is not compatible with PHP %s, please upgrade to PHP 5.3 or newer.</p></div>', phpversion() );
}
