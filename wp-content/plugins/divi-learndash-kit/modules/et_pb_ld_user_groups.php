<?php
class DLK_Builder_Module_User_Groups extends DLK_Builder_Module_Template {
	function init() {
		$this->name       = esc_html__( 'User Groups', 'et_builder' );
		$this->slug       = 'et_pb_ld_user_groups';
		...
		$this->main_css_element = '%%order_class%%.et_pb_ld_user_groups';
...
new DLK_Builder_Module_User_Groups;