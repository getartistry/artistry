<?php
class DLK_Builder_Module_Payment_Buttons extends DLK_Builder_Module_Template {
	function init() {
		$this->name       = esc_html__( 'Payment Buttons', 'et_builder' );
		$this->slug       = 'et_pb_ld_payment_buttons';
		...
		$this->main_css_element = '%%order_class%%.et_pb_ld_payment_buttons';
	...
	function get_fields() {
		...
		$fields = array(
			...
			'course_id' => array(
				...
				'description'     => esc_html__( 'Show payment buttons for selected course.', 'et_builder' ),
				'toggle_slug'     => 'main_content',
				'default' => 'all'
			),
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$shortcode = "[learndash_payment_buttons{$course_id}]";
...
new DLK_Builder_Module_Payment_Buttons;