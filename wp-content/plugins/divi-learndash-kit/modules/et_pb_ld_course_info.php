<?php
class DLK_Builder_Module_Course_Info extends DLK_Builder_Module_Template {
	function init() {
		$this->name       = esc_html__( 'Course Info', 'et_builder' );
		$this->slug       = 'et_pb_ld_course_info';
		...
		$this->main_css_element = '%%order_class%%.et_pb_ld_course_info';
	...
	function get_fields() {
		...
		$fields = array(
			...
			'user_id' => array(
				...
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Show courses for given user (or current user if blank).', 'et_builder' ),
				'toggle_slug'     => 'main_content',
			),
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$shortcode = "[ld_course_info{$user_id}]";
...
new DLK_Builder_Module_Course_Info;