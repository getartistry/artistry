<?php
class DLK_Builder_Module_Profile extends DLK_Builder_Module_Template {
	function init() {
		$this->name       = esc_html__( 'Profile', 'et_builder' );
		$this->slug       = 'et_pb_ld_profile';
		...
		$this->main_css_element = '%%order_class%%.et_pb_ld_profile';
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$shortcode_output = do_shortcode('[ld_profile order="'.esc_attr($course_order).'" orderby="'.esc_attr($course_order_by).'"]');
...
new DLK_Builder_Module_Profile;