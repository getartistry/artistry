<?php
class DLK_Builder_Module_Video extends DLK_Builder_Module_Template {
	function init() {
		$this->name       = esc_html__( 'Video', 'et_builder' );
		$this->slug       = 'et_pb_ld_video';
		...
		$this->main_css_element = '%%order_class%%.et_pb_ld_video';
