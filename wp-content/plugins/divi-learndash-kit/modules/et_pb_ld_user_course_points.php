<?php
class DLK_Builder_Module_User_Course_Points extends DLK_Builder_Module_Template {
	function init() {
		$this->name       = esc_html__( 'User Course Points', 'et_builder' );
		$this->slug       = 'et_pb_ld_user_course_points';
		...
		$this->main_css_element = '%%order_class%%.et_pb_ld_user_course_points';
	...
	function get_fields() {
		...
		$fields = array(
			...
			'user_id' => array(
				...
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Show points for given user (or current user if blank).', 'et_builder' ),
				'toggle_slug'     => 'main_content',
			),
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$shortcode = "[ld_user_course_points{$user_id}]";
...
new DLK_Builder_Module_User_Course_Points;