...
abstract class Element_Pack_Module_Base {
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'bdthemes-element-pack' ), '1.0.0' );
	}
	...
	public function get_assets_url() {
		return BDTEP_MODULES_URL . $this->get_name() . '/assets/';
	}
