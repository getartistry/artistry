...
$.fn.cs_wpColorPicker = function(str) {
      ...
      if( $this.data('rgba') !== false ) {
        ...
        $this.wpColorPicker({
            ...
            change: function( event, ui ) {
                ...
                var property    = $this.attr('data-css-property') || '';
                var unit        = $this.attr('data-unit') || 'px';
                var value       = ui_color_value;
                var input_name  = $this.attr('name'); 

                jQuery(document).trigger('cp-colorpicker-change', [$this,value,selector ,property,input_name] );
                    ...
                    create: function() {
                        ...
                        $container.on('click', '.wp-color-result', function() {
                            ...
                            if ( jQuery(this).hasClass('wp-picker-open') ) {
                                ...
                                if( jQuery(this).closest('.cp-edit-param-inputs').find('.colorpicker-spacing').length ) {
                                    jQuery(this).closest('.cp-edit-param-inputs').find('.colorpicker-spacing').css('display','block');
                                } else {
                                    jQuery(this).closest('.cp-element-container').find('.colorpicker-spacing').css('display','block');
                                }

                            } else {
                                jQuery('.colorpicker-spacing').css('display','none');
                            }
                        });
