...
<div class="wrap">
	<h1>
		...
		<a class='button-primary' href='http://user-meta.com'>Get User Meta
			Pro</a>
		<a class='button-primary' href='http://demo.user-meta.com'>Live Demo</a>
	</h1>
		...
		<div class="row">
			...
			<div class="col-sm-5">
				<?=panel('Login with username or email', '<img
						src="https://s3.amazonaws.com/user-meta/public/v1/screenshot-06.png" />')?>
			</div>

			<div class="col-sm-5">
				<?=panel('Login Config', '<img
						src="https://s3.amazonaws.com/user-meta/public/v1/screenshot-08.png" />')?>
			</div>
...
$more = "
    ...
    <center>
        <a class='button-primary' href='http://user-meta.com'>Get User Meta Pro</a>
        <a class='button-primary' href='http://demo.user-meta.com'>Live Demo</a>
    </center>
    ";
?>
