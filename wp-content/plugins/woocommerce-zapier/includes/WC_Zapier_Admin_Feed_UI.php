...
class WC_Zapier_Admin_Feed_UI {
	...
	public function __construct() {
		...
		$this->meta_fields = array(
			array(
				'type' => 'title',
				'desc' => '<p>' . esc_html( __( 'To configure your Zapier Feed, complete the information below.' , 'wc_zapier' ) ) . '</p><p>' . wp_kses_post( sprintf( __( 'Note: The setup process is quite involved, <a href="%s" target="_blank" title="(Opens in a new window)">so we strongly recommend reading the documentation</a>.', 'wc_zapier' ), WC_Zapier::documentation_url ) . ' </p>', 'wc_zapier' ),
				'id'   => "{$this->prefix}feed_details"
			),
			array(
				'id'                      => "{$this->prefix}trigger"
			, 'title'                   => __( 'Trigger', 'wc_zapier' )
//			, 'desc'                => __( 'Select the trigger that this feed applies to.', 'wc_zapier' )
			, 'type'                    => 'radio'
