...
class Aepro{
	...
	public function ae_template_canvas($template){
		if ( is_singular('ae_global_templates') ) {
			$is_canvas = get_post_meta( get_the_ID(), 'ae_enable_canvas', true );
    ...
    function _editor_enqueue_scripts(){
        ...
        wp_enqueue_script('ae-swiper',AE_PRO_URL.'includes/assets/lib/swiper/js/swiper'. AE_PRO_SCRIPT_SUFFIX .'.js',array('jquery'),'3.4.2',true);
   ...
   public function set_custom_edit_ae_global_templates_posts_columns($columns) {
    ...
    public function _enqueue_scripts(){
        ...
        wp_register_script('ae-swiper',AE_PRO_URL.'includes/assets/lib/swiper/js/swiper'. AE_PRO_SCRIPT_SUFFIX .'.js',array('jquery'),'3.4.2',true);
        wp_enqueue_style('ae-swiper',AE_PRO_URL.'includes/assets/lib/swiper/css/swiper'. AE_PRO_SCRIPT_SUFFIX .'.css');
