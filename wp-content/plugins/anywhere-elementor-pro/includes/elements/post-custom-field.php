...
class Aepro_Custom_Field extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'link_text_type',
            [
                'label' => __('Link Text Type','ae-pro'),
                'type'  => Controls_Manager::SELECT,
                'options' => [
		...
		switch ($cf_type) {
			...
			case "link":	if($settings['link_type'] == 'email'){
                            ...
                            if(!empty($settings['cf_link_text']) && $settings['link_text_type'] == 'static'){
                                ...
                                $custom_field_html = '<a '.$this->get_render_attribute_string( 'custom-field-class' ).'  href="'.$custom_field_val.'">'.get_field($settings['cf_link_dynamic_text'], $post_id).'</a>';
                            }else{
			...
			case "image":	$post_image_size = $settings['image_size'];
                            ...
                            if($settings['links_to'] == 'post'){
                                ...
                                $media_link = wp_get_attachment_image_src(get_field($settings['custom-field']),'full');
