	...
	final class Astra_Ext_Nav_Menu_Markup {
		...
		public function add_custom_fields( $id, $item, $depth, $args ) {
			...
			<p class="description description-wide">
				<a data-depth="<?php echo $depth; ?>" class="button button-secondary button-large astra-megamenu-opts-btn"><?php _e( 'Astra Menu Settings', 'astra-addon' ); ?>
				</a>
			</p>               
			<?php
		}
		...
		function render_mm_popup_html() {
			...
			<div class="astra-mm-title-wrap">
				<h2><?php _e( 'Astra Menu Options', 'astra-addon' ); ?></h2>
