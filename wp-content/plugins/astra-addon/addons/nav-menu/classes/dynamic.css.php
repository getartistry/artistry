	...
	if ( Astra_Ext_Extension::is_active( 'colors-and-background' ) ) {
		...
		if ( Astra_Ext_Extension::is_active( 'header-sections' ) ) {
			...
			$desktop_colors = array(
				...
				// Above header color.
				'.ast-desktop .ast-above-header-navigation .astra-megamenu-li li a:hover' => array(
					'color' => esc_attr( $above_header_h_color['desktop'] ),
				),
				'.ast-desktop .ast-above-header-navigation .ast-above-header-menu .astra-megamenu-li .sub-menu li a:hover' => array(
					'color' => esc_attr( $above_header_submenu_h_color['desktop'] ),
				),

				// Below header color.
				'.ast-desktop .ast-below-header-navigation .astra-megamenu-li li a:hover' => array(
					'color' => esc_attr( $below_header_h_color['desktop'] ),
				),
				'.ast-desktop .ast-below-header-navigation .astra-megamenu-li .sub-menu li a:hover' => array(
		...
		$desktop_colors = array(
			...
			'.ast-desktop .main-header-menu .astra-megamenu-li li a:hover ' => array(
				'color' => esc_attr( $primary_header_h_color['desktop'] ),
			),

			'.ast-desktop .main-header-menu .astra-megamenu-li .sub-menu li a:hover' => array(
			...
			'.ast-desktop .ast-mega-menu-enabled.main-header-menu .sub-menu li a:hover' => array(
