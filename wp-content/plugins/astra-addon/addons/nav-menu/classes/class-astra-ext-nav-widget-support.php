...
if ( ! class_exists( 'Astra_Ext_Nav_Widget_Support' ) ) {
	...
	class Astra_Ext_Nav_Widget_Support {
		...
		private function render_widget( $widget_id, $title ) {
			...
			$html .= '            <a class="widget-option widget-action item-edit" title="' . esc_attr( __( 'Edit', 'astra-addon' ) ) . '"><span class="screen-reader-text">Edit</span></a>';
			$html .= '        </div>';
		...
		public function edit_widget() {
			...
			<form method="post">
				...
				<input type="hidden" class="ast-nonce-field ast-delete-widget-nonce" name="ast-delete-widget-nonce-<?php echo $widget_id; ?>" value="<?php echo wp_create_nonce( 'ast-delete-widget-' . $widget_id ); ?>">
				...
				<div class='widget-content'>
					...
					<div class='widget-controls'>
						<a class='delete' href='#delete'><?php _e( 'Delete', 'astra-addon' ); ?></a> |
						<a class='close' href='#close'><?php _e( 'Close', 'astra-addon' ); ?></a>
					</div>
