	...
	class Astra_Custom_Nav_Walker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			if ( 0 === $depth && '' != $this->megamenu ) {
				...
				$style = array(
					'.ast-desktop .menu-item-' . $this->menu_megamenu_item_id . ' li > a, .menu-item-' . $this->menu_megamenu_item_id . ' li .sub-menu > a' => array(
						'color' => $this->megamenu_text_color,
					),
					'.ast-desktop .ast-container .menu-item-' . $this->menu_megamenu_item_id . ' li:hover, .ast-container .menu-item-' . $this->menu_megamenu_item_id . ' li .sub-menu li:hover, .ast-desktop .ast-container .menu-item-' . $this->menu_megamenu_item_id . ' li a:hover, .ast-container .menu-item-' . $this->menu_megamenu_item_id . ' li .sub-menu a:hover' => array(
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( 'enable-heading' === $item->megamenu_enable_heading /*&& 0 != $depth*/ ) {
				...
				switch ( $item->megamenu_content_src ) {
					...
					case 'template':
						...
						if ( ! empty( $template_id ) ) {
							...
							$content .= '<div class="ast-mm-template-content">';
					...
					case 'custom_text':
						$content  = '<div class="ast-mm-custom-text-content">';
					...
					case 'widget':
						...
						if ( ! empty( $widgets ) ) {
							$content = '<div class="ast-mm-widget-content">';
