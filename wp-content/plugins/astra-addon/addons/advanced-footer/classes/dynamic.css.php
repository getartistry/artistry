...
function astra_ext_footer_adv_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	$adv_footer_css_output .= astra_parse_css( $tablet_css, '', '768' );
	...
	$adv_footer_css_output .= astra_parse_css( $mobile_css, '', '544' );
	...
	if ( 'content' != $footer_adv_width ) {
		...
		$adv_footer_css_output                          .= astra_parse_css( $tablet_lr_padding, '', '768' );
		...
		$adv_footer_css_output                          .= astra_parse_css( $mobile_lr_padding, '', '544' );
