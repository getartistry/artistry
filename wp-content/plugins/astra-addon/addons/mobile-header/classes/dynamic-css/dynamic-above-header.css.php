...
function astra_ext_mobile_above_header_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	$mobile_header_close_desktop_color = astar( astra_get_option( 'above-header-menu-color-responsive' ), 'desktop', $theme_link_color );
	$mobile_header_close_tablet_color  = astar( astra_get_option( 'above-header-menu-color-responsive' ), 'tablet' );
	$mobile_header_close_mobile_color  = astar( astra_get_option( 'above-header-menu-color-responsive' ), 'mobile' );
