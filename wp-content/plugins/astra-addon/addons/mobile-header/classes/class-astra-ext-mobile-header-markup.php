...
if ( ! class_exists( 'Astra_Ext_Mobile_Header_Markup' ) ) {
	...
	class Astra_Ext_Mobile_Header_Markup {
		 ...
		 * @return void.
		 */
		function below_header_before_menu() {
		 ...
		 * @return void.
		 */
		function below_header_after_menu() {
			$mobile_below_menu_style = astra_get_option( 'mobile-below-header-menu-style' );
			if ( 'default' !== $mobile_below_menu_style ) {
				?>
		 ...
		 * @return void.
		 */
		function above_header_before_menu() {
		 ...
		 * @return void.
		 */
		function above_header_after_menu() {
			$mobile_above_menu_style = astra_get_option( 'mobile-above-header-menu-style' );
			if ( 'default' !== $mobile_above_menu_style ) {
				?>
		 ...
		 */
		function merge_header_custom_menu_item_wrap( $markup ) {
		 ...
		 * @return string $markup updated Custom menu item markup.
		 */
		function merge_header_before_custom_menu_item( $markup ) {
			$mobile_above_menu_style = astra_get_option( 'mobile-menu-style' );
			if ( 'default' !== $mobile_above_menu_style ) {
		 ...
		 * @return void.
		 */
		function merge_header_before_menu() {
		 ...
		 * @return void.
		 */
		function merge_header_after_menu() {
			$mobile_menu_style = astra_get_option( 'mobile-menu-style' );
			if ( 'default' !== $mobile_menu_style ) {
				?>
		 ...
		 * @return array;
		 */
		function above_header_menu_toggle_classes( $classes ) {
		 ...
		 * @return array;
		 */
		function below_header_menu_toggle_classes( $classes ) {
