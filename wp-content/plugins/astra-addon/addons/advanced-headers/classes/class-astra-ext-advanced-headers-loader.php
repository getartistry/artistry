		...
		public function admin_enqueue_scripts() {
			...
			if ( ( 'post-new.php' == $pagenow || 'post.php' == $pagenow ) && 'astra_adv_header' == $screen->post_type ) {
				...
				if ( SCRIPT_DEBUG ) {
					...
					wp_enqueue_script( 'astra-advanced-headers-admin', ASTRA_EXT_ADVANCED_HEADERS_URL . 'assets/js/unminified/astra-advanced-headers-admin.js', array( 'jquery', 'wp-color-picker', 'jquery-ui-tooltip' ), ASTRA_EXT_VER );
					...
					wp_enqueue_script( 'astra-advanced-headers-admin', ASTRA_EXT_ADVANCED_HEADERS_URL . 'assets/js/minified/astra-advanced-headers-admin.min.js', array( 'jquery', 'wp-color-picker', 'jquery-ui-tooltip' ), ASTRA_EXT_VER );
				}
			}
		}
