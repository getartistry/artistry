...
if ( ! class_exists( 'WPSEO_Local_Admin_API_Settings' ) ) {
	...
	class WPSEO_Local_Admin_API_Settings {
		...
		public function tab_content() {
			...
			echo '<p>' . sprintf( __( 'A Google Maps Geocoding server key will be required to calculate the latitude and longitude of an address. With this key, you can retrieve the geographical location of up to %1$s addresses per 24 hours. For more information on how to create and set your Google Maps Geocoding server key, open the help center or %2$scheck our knowledge base%3$s.', 'yoast-local-seo' ), number_format_i18n( 2500, 0 ), '<a href="https://yoa.st/gm-geocoding-api-server-key" target="_blank">', '</a>' ) . '</p>';
