<div class="wrap">
    ...
    <form method="post" action="options.php" id="gf_form_agile_settings"> 
        <?php settings_fields($this->tag . '-settings-group'); ?>
        <?php do_settings_sections($this->tag); ?>
        <?php wp_nonce_field('agilecrm_gf_account_nonce_action','agilecrm_gf_account_nonce_field'); ?>
        ...
        <?php submit_button('Save Changes', 'primary', 'gf_submit_button', false); ?>&nbsp;<span
