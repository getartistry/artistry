...
$credentials = new Credentials(
    ...
    admin_url('admin.php?page=youbrandinc-oauth&service=instagram')
//$currentUri->getAbsoluteUri()
);


if (!$cs_instagram_access_data) {
...
if (!empty($_GET['code'])) {
    ...
    $url = $currentUri->getRelativeUri() . '?page=youbrandinc-oauth&service=instagram&go=go';
    //echo "<a href='$url'>Login with Instagram!</a>";

    if (!$cs_instagram_access_data) {
        $action_link = "<a href='$url'>Login with Instagram!</a>";
    }
}