			      			...
			      			<div class="eael-admin-sidebar">
			      				<div class="eael-sidebar-block">
			      					...
			      					<div class="eael-admin-sidebar-cta">
			      						<?php printf( __( '<a href="%s" target="_blank">Manage License</a>', 'essential-addons-elementor' ), 'https://codecanyon.net/downloads' ); ?>
			      					</div>
			      				</div>
				      		...
				      		<div class="col-full">
								...
								<div class="eael-checkbox-container">
									<div class="eael-checkbox">
										...
										<p class="eael-el-title"><?php _e( 'We-Forms', 'essential-addons-elementor' ) ?></p>
									</div>
									<div class="eael-checkbox">
