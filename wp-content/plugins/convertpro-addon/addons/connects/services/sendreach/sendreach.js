(function( $ ) {
	...
	var SendReachService = {
		...
		_validateOptions: function( parentObj ) {
			...
			var list 	= $( 'select[name=sendReach_lists]' ),
				err 	= false;
			...
			SendReachService.parentObj._setisValidated( err );
		},		
