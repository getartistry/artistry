(function( $ ) {
	...
	var iContactService = {
		...
		/**
		 * Validates selected lists/segments.
		 *
		 * @return void
		 * @since 1.0.0
		 */
		...
		_validateOptions: function( parentObj ) {
			...
			var list 	= $( 'select[name=icontact_list_id]' ),
				err 	= false;
			...
			iContactService.parentObj._setisValidated( err );
		},	
