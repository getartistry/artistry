    ...
    function add_themes() {
        ...
        if (count($megamenu_themes)) {
            foreach ($megamenu_themes as $key => $theme_settings) {
                ...
                $quadmenu[$key . '_layout_width_selector'] = '';
                ...
                $quadmenu[$key . '_navbar_background_color'] = array(
                    'color' => $this->rgba2hex($theme_settings['container_background_from']),
                    'alpha' => $this->rgba2alpha($theme_settings['container_background_from']),
                );
                $quadmenu[$key . '_navbar_background_to'] = array(
                    'color' => $this->rgba2hex($theme_settings['container_background_to']),
                    'alpha' => $this->rgba2alpha($theme_settings['container_background_to']),
                );

                $quadmenu[$key . '_navbar_link'] = $this->rgba2hex($theme_settings['menu_item_link_color']);
                $quadmenu[$key . '_navbar_link_hover'] = $this->rgba2hex($theme_settings['menu_item_link_color_hover']);

                $quadmenu[$key . '_navbar_link_bg'] = array(
                    'color' => $this->rgba2hex($theme_settings['menu_item_background_from']),
                    'alpha' => $this->rgba2alpha($theme_settings['menu_item_background_from']),
                );

                //QuadMenu::send_json_error($theme_settings['menu_item_background_from']);

                $quadmenu[$key . '_navbar_link_bg_hover'] = array(
                    'color' => $this->rgba2hex($theme_settings['menu_item_background_hover_from']),
                    'alpha' => $this->rgba2alpha($theme_settings['menu_item_background_hover_from']),
                );
                ...
                $quadmenu[$key . '_dropdown_background'] = array(
                    'color' => $this->rgba2hex($theme_settings['flyout_menu_background_from']),
                    'alpha' => $this->rgba2alpha($theme_settings['flyout_menu_background_from']),
                );
                ...
                $quadmenu[$key . '_dropdown_link_bg_hover'] = array(
                    'color' => $this->rgba2hex($theme_settings['flyout_background_hover_from']),
                    'alpha' => $this->rgba2alpha($theme_settings['flyout_background_hover_from']),
                );
