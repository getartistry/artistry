    ...
    if ( ! class_exists( 'ReduxFramework_extension_advanced_customizer' ) ) {
        ...
        class ReduxFramework_extension_advanced_customizer {
            ...
            function create_field_classes( $option ) {
                include_once '/inc/advanced_customizer_classes.php';
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                if ( ! class_exists( 'Redux_Advanced_Customizer_Section' ) ) {
                    ...
                    include_once '/inc/advanced_customizer_section.php';
                ...
                if ( ! class_exists( 'Redux_Advanced_Customizer_Panel' ) ) {
                    ...
                    include_once '/inc/advanced_customizer_panel.php';
                ...
                if ( ! class_exists( 'Redux_Advanced_Customizer_Section' ) ) {
                    include_once 'advanced_customizer_section.php';
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Redux_Advanced_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Redux_Advanced_Customizer_Panel' ) ) {
                    include_once 'advanced_customizer_panel.php';
                    if ( method_exists( $wp_customize, 'register_panel_type' ) ) {
                        $wp_customize->register_panel_type( 'Redux_Advanced_Customizer_Panel' );
                    }
                }
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => __( 'You have changes that are not saved. Would you like to save them now?', 'quadmenu' ),
                    'reset_confirm'  => __( 'Are you sure? Resetting will lose all custom values.', 'quadmenu' ),
                    'preset_confirm' => __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'quadmenu' ),
