 ...
 * @see Walker_Nav_Menu
 */
class QuadMenu_Walker_Nav_Menu_Edit extends Walker_Nav_Menu {
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        $classes = array(
            ...
            'menu-item-' . esc_attr($item->quadmenu),
        ...
        <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes); ?>">
            <div class="menu-item-bar">
                <div class="menu-item-handle">
                    <span class="item-title">
                        ...
                        <?php if (empty($item->_invalid)) : ?>
                            <span class="quadmenu_open"><?php echo QUADMENU_NAME; ?></span>
                        <?php endif; ?>
            ...
            <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
                ...
                <div class="menu-item-actions description-wide submitbox">
                    ...
                    ?>"><?php esc_html_e('Remove'); ?></a> <span class="meta-sep hide-if-no-js"> | </span> <a class="item-cancel submitcancel hide-if-no-js" id="cancel-<?php echo $item_id; ?>" href="<?php echo esc_url(add_query_arg(array('edit-menu-item' => $item_id, 'cancel' => time()), admin_url('nav-menus.php')));
