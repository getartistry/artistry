(function ($) {
    ...
    var add_submit_events = function (submit) {
        ...
        submit.on('click', function (e) {
            ...
            menuItems[ -1] = {
                ...
                'menu-item-title': submit.data('menu_item_title'),
        ...
        $('.sortable-area', modal).each(function () {
            ...
            $sortable.sortable({
                ...
                start: function (event, ui) {
                    //$($sortable.data('sortable-items')).removeClass('open');
    ...
    var add_save_events = function (panel) {
        ...
        $form.on('change.quadmenu.settings', function (e) {
            e.preventDefault();
            var $form = $(this);
            $.ajax({
                type: 'post',
