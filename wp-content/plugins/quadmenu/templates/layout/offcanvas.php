<nav id="quadmenu" class="<?php echo esc_attr($args->navbar_class); ?> quadmenu-is-horizontal" data-unwrap="<?php echo esc_attr($args->unwrap); ?>" data-width="<?php echo esc_attr($args->layout_width); ?>" data-selector="<?php echo esc_attr($args->layout_width_selector); ?>" data-breakpoint="<?php echo esc_attr($args->layout_breakpoint); ?>" data-sticky="<?php echo esc_attr($args->layout_sticky); ?>" data-sticky-offset="<?php echo esc_attr($args->layout_sticky_offset); ?>">
