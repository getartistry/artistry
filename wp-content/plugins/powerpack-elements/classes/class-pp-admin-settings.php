...
final class PP_Admin_Settings {
	...
	{
		// Styles
		//wp_enqueue_style( 'pa-admin-settings', WOOPACK_URL . 'assets/css/admin-settings.css', array(), POWERPACK_ELEMENTS_VER );
	}
    ...
    {
		include POWERPACK_ELEMENTS_PATH . 'includes/admin-settings.php';
    }
