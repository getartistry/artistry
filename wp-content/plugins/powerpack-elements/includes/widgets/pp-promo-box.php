            ...
            <div class="pp-promo-box-wrap">
                <div class="pp-promo-box-inner">
                    <div class="pp-promo-box-inner-content">
                        ...
                        <# if ( settings.heading != '' ) { #>
                            <h4 class="pp-promo-box-title elementor-inline-editing" data-elementor-setting-key="heading" data-elementor-inline-editing-toolbar="none">
                                {{ settings.heading }}
                            </h4>
                        <# } #>
                        ...
                        <# if ( settings.sub_heading != '' ) { #>
                            <h5 class="pp-promo-box-subtitle elementor-inline-editing" data-elementor-setting-key="sub_heading" data-elementor-inline-editing-toolbar="none">
                        ...
                        <# if ( settings.content != '' ) { #>
                            <div class="pp-promo-box-content elementor-inline-editing" data-elementor-setting-key="content" data-elementor-inline-editing-toolbar="none">
                                {{ settings.content }}
                            </div>
                        <# } #>
                        ...
                        <# if ( settings.button_switch == 'yes' ) { #>
                            <# if ( settings.button_text != '' ) { #>
                                <div class="pp-promo-box-footer">
                                    <a href="{{ settings.link.url }}" class="pp-promo-box-button elementor-button elementor-size-{{ settings.button_size }} elementor-animation-{{ settings.button_hover_animation }} elementor-inline-editing" data-elementor-setting-key="button_text" data-elementor-inline-editing-toolbar="none">
