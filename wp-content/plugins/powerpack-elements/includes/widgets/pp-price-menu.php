                        ...
                        <div class="pp-restaurant-menu-item">
                            ...
                            <div class="pp-restaurant-menu-content">
                                        ...
                                        <h4 class="pp-restaurant-menu-title">
                                            <# if ( item.link && item.link.url ) { #>
                                                <a href="{{ item.link.url }}">
                                                    <span class="pp-restaurant-menu-title-text elementor-inline-editing" data-elementor-setting-key="menu_items.{{ $i - 1 }}.menu_title" data-elementor-inline-editing-toolbar="none">
                                                        {{ item.menu_title }}
                                                    </span>
                                                </a>
                                            <# } else { #>
                                        ...
                                        <# if ( item.menu_price != '' ) { #>
                                            <span class="pp-restaurant-menu-price">
                                                <# if ( item.discount == 'yes' ) { #>
                                                    <span class="pp-restaurant-menu-price-original elementor-inline-editing" data-elementor-setting-key="menu_items.{{ $i - 1 }}.original_price" data-elementor-inline-editing-toolbar="none">
                                                        {{ item.original_price }}
                                                    </span>
                                                <# } #>
                                                <span class="pp-restaurant-menu-price-discount elementor-inline-editing" data-elementor-setting-key="menu_items.{{ $i - 1 }}.menu_price" data-elementor-inline-editing-toolbar="none">
                                                    {{ item.menu_price }}
                                                </span>
                                            </span>
                                        <# } #>
                                ...
                                <# if ( item.menu_description != '' ) { #>
                                    <div class="pp-restaurant-menu-description elementor-inline-editing" data-elementor-setting-key="menu_items.{{ $i - 1 }}.menu_description" data-elementor-inline-editing-toolbar="basic">
