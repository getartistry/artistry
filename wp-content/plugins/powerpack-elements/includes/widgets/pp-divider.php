 ...
 * Divider Widget
 */
class PP_Divider_Widget extends Widget_Base {
    ...
    public function get_icon() {
        return 'eicon-divider power-pack-admin-icon';
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new PP_Divider_Widget() );