...
class PP_Team_Member_Widget extends Widget_Base {
    ...
    protected function _name_template() {
        ?>
        <# if ( settings.team_member_name != '' ) { #>
            <{{ settings.name_html_tag }} class="pp-tm-name elementor-inline-editing" data-elementor-inline-editing-toolbar="none" data-elementor-setting-key="team_member_name">
    ...
    protected function _position_template() {
        ?>
        <# if ( settings.team_member_position != '' ) { #>
            <{{ settings.position_html_tag }} class="pp-tm-position elementor-inline-editing" data-elementor-inline-editing-toolbar="none" data-elementor-setting-key="team_member_position">
                {{ settings.team_member_position }}
    ...
    protected function _description_template() {
        ...
        <# if ( settings.team_member_description_switch == 'yes' ) { #>
            <# if ( settings.team_member_description != '' ) { #>
                <div class="pp-tm-description elementor-inline-editing" data-elementor-inline-editing-toolbar="base" data-elementor-setting-key="team_member_description">
