                ...
                <# _.each( settings.table_headers, function( item ) { #>
                    <th id="{{ item.css_id }}" class="pp-table-cell pp-table-cell-{{ item._id }} {{ item.css_classes }} pp-table-cell-icon-{{ item.cell_icon_position }}" colspan="{{ item.col_span }}" rowspan="{{ item.row_span }}" {{ $sortable_header }}>
                        <span class="pp-table-cell-content">
                            ...
                            <# } #>
                            <span class="pp-table-cell-text elementor-inline-editing" data-elementor-setting-key="table_headers.{{ $i - 1 }}.table_header_col" data-elementor-inline-editing-toolbar="basic">{{{ item.table_header_col }}}</span>
                        </span>
                    </th>
                <# $i++; } ); #>
            </tr>
                        ...
                        <# if ( item.cell_text != '' || item.cell_icon_type != 'none' ) { #>
                            <td id="{{ item.css_id }}" class="pp-table-cell pp-table-cell-{{ item._id }} {{ item.css_classes }} pp-table-cell-icon-{{ item.cell_icon_position }}" colspan="{{ item.col_span }}" rowspan="{{ item.row_span }}">
                                <span class="pp-table-cell-content">
                                    ...
                                    <# } #>
                                    <span class="pp-table-cell-text elementor-inline-editing" data-elementor-setting-key="table_footer_content.{{ $i - 1 }}.table_header_col" data-elementor-inline-editing-toolbar="basic">{{{ item.cell_text }}}</span>
                                </span>
                            </td>
                        <# } #>
                    <# } else { #>
                    ...
                    <# if ( item.cell_text != '' || item.cell_icon_type != 'none' ) { #>
                        <td id="{{ item.css_id }}" class="pp-table-cell pp-table-cell-{{ item._id }} {{ item.css_classes }} pp-table-cell-icon-{{ item.cell_icon_position }}" colspan="{{ item.col_span }}" rowspan="{{ item.row_span }}">
                            <span class="pp-table-cell-content">
                                ...
                                <# } #>
                                <span class="pp-table-cell-text elementor-inline-editing" data-elementor-setting-key="table_body_content.{{ $i - 1 }}.table_header_col" data-elementor-inline-editing-toolbar="basic">{{{ item.cell_text }}}</span>
                            </span>
                        </td>
                    <# } #>
                <# } else { #>
