...
<div class="wrap">
    ...
    <?php PP_Admin_Settings::render_update_message(); ?>
    ...
    <form method="post" id="pp-settings-form" action="<?php echo self::get_form_action( '&tab=' . $current_tab ); ?>">
        ...
        if ( ! isset($_GET['tab']) || 'general' == $current_tab ) {
            include POWERPACK_ELEMENTS_PATH . 'includes/admin-settings-license.php';
        }

        // White Label settings.
        if ( 'white-label' == $current_tab ) {
            include POWERPACK_ELEMENTS_PATH . 'includes/admin-settings-wl.php';
        }

        // Modules settings.
        if ( 'modules' == $current_tab ) {
            include POWERPACK_ELEMENTS_PATH . 'includes/admin-settings-modules.php';
        }
        ?>
