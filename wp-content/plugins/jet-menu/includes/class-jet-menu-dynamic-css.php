	...
	class Jet_Menu_Dynamic_CSS {
		...
		public function get_fonts_list() {
			...
			if ( empty( $this->fonts ) ) {
				...
				$this->fonts = array_merge( array( '0' => esc_html__( 'Select Font...', 'jet-emnu' ) ), $this->fonts );
			}
		...
		public function add_borders( $wrapper = '' ) {
			...
			$options = apply_filters( 'jet-menu/menu-css/borders', array(
				...
				'jet-menu-last-item'         => array(
					'> .jet-regular-item:nth-last-child(2) .top-level-link',
				...
				'jet-menu-last-item-hover'   => array(
					'> .jet-regular-item:nth-last-child(2):hover > .top-level-link',
				...
				'jet-menu-last-item-active'  => array(
					'> .jet-regular-item.jet-current-menu-item:nth-last-child(2) .top-level-link',
