	...
	class FullWidthTemplates {
		...
		protected function init() {
			...
			$this->templates = apply_filters( 'fwpt_templates_list', array(
				'templates/builder-fullwidth.php'     => '&harr; ' . __( 'Page Builder - Full Width - Blank', 'elementor-addon-widgets' ),
				'templates/builder-fullwidth-std.php' => '&harr; ' . __( 'Page Builder - Full Width', 'elementor-addon-widgets' ),
			) );
