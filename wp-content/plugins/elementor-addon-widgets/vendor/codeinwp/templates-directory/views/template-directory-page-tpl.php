...
if ( is_array( $templates_array ) ) { ?>
	<div class="obfx-template-dir wrap">
        ...
        <h2 class="wp-heading-inline"> <?php echo apply_filters( 'obfx_template_dir_page_title', __( 'Orbit Fox Template Directory', 'elementor-addon-widgets' ) ); ?></h2>
        <button id="obfx-template-dir-fetch-templates" class="button-primary button"><i class="dashicons dashicons-update"></i><?php echo __( 'Sync Templates', 'elementor-addon-widgets' ); ?></button>
			...
			foreach ( $templates_array as $template => $properties ) {
				...
				<div class="obfx-template">
					...
					<div class="more-details obfx-preview-template"
						...
						<span><?php echo __( 'More Details', 'elementor-addon-widgets' ); ?></span></div>
					...
					<div class="obfx-template-actions">
						...
						<?php if ( ! empty( $properties['demo_url'] ) ) { ?>
							<a class="button obfx-preview-template"
							   data-demo-url="<?php echo esc_url( $properties['demo_url'] ); ?>"
							   data-template-slug="<?php echo esc_attr( $template ); ?>"><?php echo __( 'Preview', 'elementor-addon-widgets' ); ?></a>
						<?php } ?>
					</div>
				</div>
			<?php } ?>
	...
	<div class="wp-full-overlay-sidebar">
		<div class="wp-full-overlay-header">
			<button class="close-full-overlay"><span
						class="screen-reader-text"><?php esc_html_e( 'Close', 'elementor-addon-widgets' ); ?></span></button>
			<div class="obfx-next-prev">
				<button class="previous-theme"><span
							class="screen-reader-text"><?php esc_html_e( 'Previous', 'elementor-addon-widgets' ); ?></span></button>
				<button class="next-theme"><span
							class="screen-reader-text"><?php esc_html_e( 'Next', 'elementor-addon-widgets' ); ?></span></button>
			</div>
			<span class="obfx-import-template button button-primary"><?php esc_html_e( 'Import', 'elementor-addon-widgets' ); ?></span>
			<a href="https://themeisle.com/plugins/sizzify-elementor-addons-templates" target="_blank"
  class="obfx-upsell-button button button-primary"><?php esc_html_e( 'See Pro Version', 'elementor-addon-widgets' ); ?></a>
				...
				<div class="install-theme-info obfx-theme-info <?php echo esc_attr( $template ); ?>"
					...
					if ( ! empty( $properties['required_plugins'] ) && is_array( $properties['required_plugins'] ) ) { ?>
						<div class="obfx-required-plugins">
							<p><?php esc_html_e( 'Required Plugins', 'elementor-addon-widgets' ); ?></p>
							<?php
		...
		<div class="wp-full-overlay-footer">
			<button type="button" class="collapse-sidebar button" aria-expanded="true" aria-label="Collapse Sidebar">
				...
				<span class="collapse-sidebar-label"><?php esc_html_e( 'Collapse', 'elementor-addon-widgets' ); ?></span>
			</button>
			<div class="devices-wrapper">
				<div class="devices obfx-responsive-preview">
					<button type="button" class="preview-desktop active" aria-pressed="true" data-device="desktop">
						<span class="screen-reader-text"><?php esc_html_e( 'Enter desktop preview mode', 'elementor-addon-widgets' ); ?></span>
					</button>
					<button type="button" class="preview-tablet" aria-pressed="false" data-device="tablet">
						<span class="screen-reader-text"><?php esc_html_e( 'Enter tablet preview mode', 'elementor-addon-widgets' ); ?></span>
					</button>
					<button type="button" class="preview-mobile" aria-pressed="false" data-device="mobile">
						<span class="screen-reader-text"><?php esc_html_e( 'Enter mobile preview mode', 'elementor-addon-widgets' ); ?></span>
					</button>
				</div>
			</div>
