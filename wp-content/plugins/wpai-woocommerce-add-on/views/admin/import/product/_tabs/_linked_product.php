<div class="panel woocommerce_options_panel" id="linked_product_data" style="display:none;">
	...
	<div class="options_group grouping show_if_simple show_if_external show_if_variable">
		...
		<p class="form-field wpallimport-radio-field">
			...
			<a href="#help" class="wpallimport-help" sstyle="top:2px;" title="<?php _e('Product will be assigned as the child of an already created product matching the specified criteria.', PMWI_Plugin::TEXT_DOMAIN); ?>">?</a>
		</p>
