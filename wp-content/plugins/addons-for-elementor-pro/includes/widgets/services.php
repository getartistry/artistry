    ...
    protected function render() {
        ...
        <div class="lae-services lae-<?php echo $settings['style']; ?> lae-grid-container">
            ...
            <?php foreach ($settings['services'] as $service): ?>
                ...
                <?php list($animate_class, $animation_attr) = lae_get_animation_atts($service['widget_animation']); ?>
                        ...
                        <?php if ($service['icon_type'] == 'icon_image') : ?>
                            ...
                            <?php if (!empty($service['icon_image'])): ?>
                                ...
                                <div class="lae-image-wrapper">
                                    ...
                                    <?php $image_html = lae_get_image_html($service['icon_image'], 'thumbnail_size', $settings); ?>
