...
class Mo_SAML2_Assertion
{
    ...
    public function __construct(DOMElement $xml = NULL)
    {
		...
		// 		$data = Mo_SAML_Utilities ::xpQuery($xml, './xenc:EncryptedData');
		// 		$encryptedMethod =  Mo_SAML_Utilities ::xpQuery($xml, './xenc:EncryptedData/ds:KeyInfo');
		// 		$method = $encryptedMethod[0]->firstChild->firstChild->getAttribute("Algorithm");
		// 		$algo = Mo_SAML_Utilities ::getEncryptionAlgorithm($method);
		// 		if (count($data) === 0) {
		...
		// 		$blacklist = array();
		// 		$xml = Mo_SAML_Utilities ::decryptElement($data[0], $key, $blacklist, $alternateKey);
		// }
    ...
    private function parseSubject(DOMElement $xml)
    {
        ...
        /*$subjectConfirmation = Mo_SAML_Utilities ::xpQuery($subject, './saml_assertion:SubjectConfirmation');
