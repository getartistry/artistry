...
include 'mo-ga-sso-login-settings-page.php';
	...
	<!-- <form  name="mo_ga_sso_saml_form_am" method="post" action="" id="mo_ga_sso_idp_config">-->
		...
		<tr>
			<td colspan="2">
			 <div>
			 	<?php if(mo_ga_login_is_customer_registered()){?>
				<form id="mo_ga_sso_cloud_broker" method="post" action="">	
					<p>
							<div hidden id="help_working_desc1" class="mo_ga_sso_help_desc">
								<h3>Option 1: Using miniOrange Single Sign On service:</h3>
								<div style="display:block;text-align:center;">
								<img src="<?php echo plugin_dir_url(__FILE__) . 'images/mo_ga_sso_saml_working.png'?>" alt="Working of miniOrange SAML plugin" style="width: 85%;"/>
								</div>
								<ol>
							...
							<div hidden id="help_working_desc2" class="mo_ga_sso_help_desc">
								<h3>Option 2 : Not Using miniOrange Single Sign On service:</h3>
								<div style="display:block;text-align:center;">
								<img src="<?php echo plugin_dir_url(__FILE__) . 'images/mo_ga_sso_saml_working_womo.png'?>" alt="Working of miniOrange SAML plugin" style="width: 55%;"/>
								</div>
								<ol>
				...
				<h3><b>Step 1:</b></h3><h4>You will need the following information to configure your Google Apps ( IdP ). Copy it and keep it handy:</h4>
				<table border="1" style="background-color:#FFFFFF; border:1px solid #CCCCCC; padding:0px 0px 0px 10px; margin:2px; border-collapse: collapse; width:98%">
					...
					<tr>
						...
						<tr>
							...
							<td style="width:60%;  padding: 15px;">Available in the <a href="<?php echo admin_url('admin.php?page=mo_ga_sso_settings&tab=licensing');?>"><b>standard, premium and enterprise</b></a> version</td>
						</tr>
