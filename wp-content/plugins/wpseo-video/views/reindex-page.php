...
<p>
	<strong><?php _e( 'Estimated time to go:', 'yoast-video-seo' ); ?> <span class="video_seo_timetogo" id="video_seo_total_time">-- : --</span></strong><br />
...
<?php printf(
	...
	__( '%1$sDone! Go back to the Video SEO settings%2$s', 'yoast-video-seo' ),
	'<a href="admin.php?page=wpseo_video" class="button button-primary">',
	'</a>'
); ?>
</p>
